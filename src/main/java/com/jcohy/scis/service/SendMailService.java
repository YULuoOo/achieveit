...
import com.jcohy.scis.model.SendMail;
...
public class SendMailService {
    ...
    public  boolean sendmail(String mailto, String username){
        ...
        String MailSubject="AchieveIT International - Application Received";
        String MailBCopyTo="";
        String MailCopyTo="";
        String MailBody="<p><img alt=\"westlakelogo\" src=\"http://img3.imgtn.bdimg.com/it/u=1102672249,3720827856&fm=15&gp=0.jpg\" border=\"0\" /></p>"
                +"<h1>Welcome to use AchieveIT System. Dear "+username+",<br />" +
                "<br />" +
                "	^_^</h1>" +
