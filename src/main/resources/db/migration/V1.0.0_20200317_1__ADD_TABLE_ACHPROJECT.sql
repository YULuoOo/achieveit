...
-- ----------------------------
INSERT INTO `ach_project` VALUES ('1', 'AchieveIT软件管理项目', 'AchieveIt是一款软件项目管理平台，面向于企业和团队提供数字化协同办公工具', '前端：JavaS vue.js 后端：Java Springboot', '涉及项目管理，团队协作以及数据存储', '项目申请，项目审批，QA管理', '1', '2020-04-22', '2020-02-20');
