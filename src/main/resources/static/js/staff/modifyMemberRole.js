 ...
 **/
var options = [{text: '项目成员', value: '项目成员'},
    {text: 'EPG', value: 'EPG'},
    {text: 'QA', value: 'QA'},
    {text: '配置管理员', value: '配置管理员'}];
layui.define(['layer', 'table','form'], function(exports){
    ...
    table.render({
        elem: '#staff'
        ,method:'GET'
        ,url: '/staff/project/'+getQueryVariable("id")+'/projectStaffs'
        ,page: true //开启分页
        ,height: 'full-200'
        ,cols: [[ //表头
            {type:'checkbox'}
            ...
            ,{field: 'staff_role', align:'center', title: '目前角色',unresize:true}
            ,{field:'classify', title: '分配新角色', templet:'#selectTpl'}
        ]]
        ,id: 'idTest'
        ,done:function() {
            var that = this;
    ...
    $('#getCheckData').click(function () {
        ...
        if (arr === undefined || arr.length == 0) {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "/staff/project/"+getQueryVariable("id")+"/modifyMemberRole",
    ...
    exports('staff/modifyMemberRole', {}); //注意，这里是模块输出的核心，模块名必须和use时的模块名一致
});